...
public class BlobTransferIntegrationTest extends AbstractBlobTransferTest {
    ...
    public static final String LOCAL_SOURCE_BLOB_STORE_ACCOUNT = "serviceassets";
    public static final String LOCAL_SOURCE_BLOB_STORE_ACCOUNT_KEY = "key1";
    public static final String LOCAL_DESTINATION_BLOB_STORE_ACCOUNT = "versicherungassets";
